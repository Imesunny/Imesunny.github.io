    ...
    <section data-aos="fade-up" className="about section sections" id="about">
      ...
      <div>
        <div data-aos="fade-up" className=" first">
          ...
          Welcome to my coding realm, where I transform coffee into lines of code! <p style={{ display: 'inline-block' }} className="sauce">I'm Sunny</p>
        ...
        rel="noreferrer" href={resume} download={"Sunny_Anand_Resume"} id="resume-button-2" className="contact-button resume-button second-btn">
          Resume</a>
      </div>
    </section>
  );
